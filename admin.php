...
<div align="center">
      <table width="1055" height="222" border="0">
        ...
        <tr>
            ...
            <input type="text" name="name" id="name" value="" placeholder="Please enter Name of the meal..." />
            <label for="fname"><br />
            Price</label>
            <input type="text" id="price" name="price" value="" placeholder="Please enter a price" oninput="validateNumber(this)"/>
            <label for="age"><br />
            Remark</label>
            <input type="text" id="remark" name="remark" value="" placeholder="Please enter a remark..." />
            <br>
